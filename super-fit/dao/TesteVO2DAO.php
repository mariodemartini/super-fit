    ...
    class TesteVO2DAO
    {
        public function create(TesteVO2 $teste_vo2){
            try {
                ...
                $p_sql->bindValue(":fc_repouso", $teste_vo2->getFc_repouso());
                $p_sql->bindValue(":pressao_inicio", $teste_vo2->getPressao_inicio());
                $p_sql->bindValue(":pressao_final", $teste_vo2->getPressao_final());
                $p_sql->bindValue(":fc_teste", $teste_vo2->getFc_teste());
                $p_sql->bindValue(":tempo_teste", $teste_vo2->getTempo_teste());
                $p_sql->bindValue(":velocidade_teste", $teste_vo2->getVelocidade_teste());
                $p_sql->bindValue(":esforco_teste", $teste_vo2->getEsforco_teste());
                $p_sql->bindValue(":resultado_vo2", $teste_vo2->getResultado_vo2());
        ...
        public function delete(TesteVO2 $teste_vo2){
            try {
                ...
                $p_sql = Conexao::getConexao()->prepare($sql);
                $p_sql->bindValue(":idTesteVO2", $teste_vo2->getIdTesteVO2());
                return $p_sql->execute();
            } catch (Exception $e) {
