...
<main>
    <div class="container-fluid px-4 text-center">
        ...
        <!-- Modal -->
        <?php foreach ($alunodao->read() as $aluno): ?>
            <div class="modal fade" id="editar><?= $aluno->getIdAluno() ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                            ...
                            <form action="controller/AlunoController.php" method="POST">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-floating">
                                            <input class="form-control" id="inputEstado" type="text" placeholder="Estado"
                                                name="estado" value="<?= $aluno->getEstado() ?>" require />
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-floating mb-3 mb-md-0">
                                            <input class="form-control" id="inputCidade" type="text" placeholder="Cidade"
                                                name="cidade" value="<?= $aluno->getCidade() ?>" require />
                                    ...
                                    <div class="col-md-8">
                                        <div class="form-floating">
                                            <input class="form-control" id="inputEndereco" type="text"
                                                placeholder="endereco" name="endereco" value="<?= $aluno->getEndereco() ?>"
                                                require />
                                ...
                                <div class="form-floating mb-3">
                                    <input class="form-control" id="inputEmail" type="email" placeholder="nome@exemplo.com"
                                        name="email" value="<?= $aluno->getEmail() ?>" require />
        ...
        <div class="col-sm-1 mt-4 mb-0">
            <button type="button" class="btn btn-secondary"><a class="btn btn-secondary btn-block"
                    href="cadastro.php">Voltar</a></button>
        </div>
</main>
