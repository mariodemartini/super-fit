        ...
        <div class="row justify-content-center">
            <div class="col-lg-12">
                ...
                <div class="card shadow-lg border-0 rounded-lg mt-5">
                    <div class="card-header"><h3 class="text-center font-weight-light my-4">VO² BICICLETA</h3></div>
                    ...
                    <div class="card-body">
                        <form action="" method="POST">
                            ...
                            <div class="row mb-3">
                                <h3>TESTE PROGRESSIVO DE BICICLETA</h3>
                                <p>Início com velocidade de 60 rpm e carga de aquecimento. A cada 2 minutos aumenta 1 carga mantendo em 60 rpm.</p>
                                <p>Caso acabe o nível de carga a velocidade deve aumentar em 20 rpm a cada 2 minutos.</p>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="form-group col-md-3">
                                    <label for="inputVelInicio" class="col-sm-8 col-form-label">Carga Inicial</label>
                                    <div class="col-sm-5">
                                        <input type="number" class="form-control" id="inputVelInicio" placeholder="watts">
                                    </div>
                                </div>
                                <div class="form-group col-md-3">
                                ...
                                <div class="form-group col-md-3">
                                    <label for="inputPA" class="col-sm-5 col-form-label">PA Repouso</label>
                                    <div class="col-sm-5">
