                ...
                <?php foreach ($professordao->exibeProf() as $professor) : ?>
                    <tr>
                        ...
                        <td class="text-center">
                            ...
                            <button class="btn  btn-warning btn-sm" data-toggle="modal" data-target="#editar><?= $professor->getIdProfessor() ?>">
                                    Editar
                                </button>
                                    ...
                                    <form action="Controller/ProfessorController.php" method="POST">
                                        <!-- Campo data -->
                                            ...
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-floating mb-3 mb-md-0">
                                                        <input class="form-control" id="inputDataNascimento" type="date" placeholder="Data de Nascimento" name="dataNascimento" value="<?= $professor->getDataNascimento() ?>" require/>
                                            ...
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-floating">
                                                        <input class="form-control" id="inpuRg" type="text" placeholder="CREF" name="cref" value="<?= $professor->getCref() ?>" require/>
