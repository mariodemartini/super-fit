                        ...
                        <form action="controller/TreinoController.php" method="POST">
                            <div class="row mb-3">
                                <div class="form-group col-md-1">
                                    ...
                                    <input type="text" class="form-control" id="inputData" name="idAluno" value="">
                                </div>
                                    ...
                                    <fieldset class="form-group">
                                        <div class="col-sm-12">
                                            ...
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" name="nivel" id="exampleRadios1" value="iniciante" >
                                                <label class="form-check-label" for="exampleRadios1">Iniciante</label>
                                            </div>
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" name="nivel" id="exampleRadios1" value="intermediario I" >
                                                <label class="form-check-label" for="exampleRadios1">Intermediário I</label>
                                            </div>
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" name="nivel" id="exampleRadios1" value="intermediario II" >
                                                <label class="form-check-label" for="exampleRadios1">Intermediário II</label>
                                            </div>
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" name="nivel" id="exampleRadios1" value="avancado" >
                                ...
                                <div class="form-group col-md-4">
                                    <fieldset class="form-group">
                                        <div class="col-sm-12">
                                            ...
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" name="fase" id="exampleRadios1" value="adaptacao">
                                                <label class="form-check-label" for="exampleRadios1">Adaptação</label>
                                            </div>
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" name="fase" id="gridRadios" value="forca">
                                                <label class="form-check-label" for="gridRadios2">Força</label>
                                            </div>
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" name="fase" id="gridRadios" value="hipertrofia">
                                                <label class="form-check-label" for="gridRadios2">Hipertrofia</label>
                                            </div>
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" name="fase" id="gridRadios" value="rml">
                                ...
                                <div class="form-group col-md-4">
                                    <fieldset class="form-group">
                                        <div class="col-sm-12">
                                            <legend class="col-form-label col-sm-7 pt-0">Nível de treino:</legend>
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" name="nivel" id="exampleRadios1" value="1">
                                                <label class="form-check-label" for="exampleRadios1">Iniciante</label>
                                            </div>
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" name="nivel" id="exampleRadios1" value="2">
                                                <label class="form-check-label" for="exampleRadios1">Intermediário I</label>
                                            </div>
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" name="nivel" id="exampleRadios1" value="3">
                                                <label class="form-check-label" for="exampleRadios1">Intermediário II</label>
                                            </div>
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" name="nivel" id="exampleRadios1" value="4">
                                                <label class="form-check-label" for="exampleRadios1">Avançado</label>
                                            </div>
                                        </div>
                                    </fieldset>
                                ...
                                <div class="form-group col-md-4">
                                    <fieldset class="form-group">
                                        <div class="col-sm-12">
                                            <legend class="col-form-label col-sm-7 pt-0">Fase do treino:</legend>
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" name="fase" id="gridRadios" value="adaptacao">
                                                <label class="form-check-label" for="gridRadios2">Adaptação</label>
                                            </div>
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" name="fase" id="gridRadios" value="resistencia">
                                                <label class="form-check-label" for="gridRadios2">Resistência</label>
                                            </div>
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" name="fase" id="gridRadios" value="hiit">
                                                <label class="form-check-label" for="gridRadios2">HIIT</label>
                                            </div>
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" name="fase" id="gridRadios" value="recuperativo">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="tab-content" id="nav-tabContent">
                                            ...
                                            <div class="tab-pane fade" id="nav-segunda" role="tabpanel" aria-labelledby="nav-segunda-tab">
                                                <form action="">
                                                    <div class="row mb-1 mt-3">
                                                        <div class="form-group mt-1 col-2">GM</div>
                                                        <div class="form-group mt-1 col-4">Exercicio</div>
                                                        <div class="form-group mt-1 col-2">Carga</div>
                                                    </div>
                                                    <?php for ($i = 0; $i < 10; $i++) { ?>
                                                        <div class="row mb-1">
                                                            <div class="form-group mt-1 col-2">
                                                                <select class="form-control custom-select" id="grupoMuscular" name="grupoMuscular">
                                                                    <option value="">Selecione</option>
                                                                    <option value="PTL">PEITORAL</option>
                                                                    <option value="CTS">COSTAS</option>
                                                                    <option value="COX">COXA</option>
                                                                    <option value="BIC">BICEPS</option>
                                                                    <option value="TRI">TRICEPS</option>
                                                                    <option value="OMB">OMBRO</option>
                                                                    <option value="GLT">GLUTEO</option>
                                                                    <option value="ABD">ABDOMEN</option>
                                                                    <option value="EST">ESTEIRA</option>
                                                                    <option value="BIK">BIKE</option>
                                                                    <option value="ELI">ELIPTICO</option>
                                    ...
                                    <div class="tab-pane fade" id="nav-s6" role="tabpanel" aria-labelledby="nav-s6-tab">
                                        ...
                                        <nav>
                                            <div class="nav nav-tabs" id="nav-tab" role="tablist">
                                                <a class="nav-item nav-link bg-info text-white" id="nav-segunda6-tab" data-toggle="tab" href="#nav-segunda6" role="tab" aria-controls="nav-segunda6" aria-selected="false">Segunda</a>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="tab-content" id="nav-tabContent">
                                    ...
                                    <div class="tab-pane fade" id="nav-s8" role="tabpanel" aria-labelledby="nav-s8-tab">
                                        ...
                                        <nav>
                                            <div class="nav nav-tabs" id="nav-tab" role="tablist">
                                                <a class="nav-item nav-link bg-info text-white" id="nav-segunda8-tab" data-toggle="tab" href="#nav-segunda8" role="tab" aria-controls="nav-segunda8" aria-selected="false">Segunda</a>
                                    ...
                                    <div class="tab-pane fade" id="nav-s10" role="tabpanel" aria-labelledby="nav-s10-tab">
                                        ...
                                        <div class="tab-content" id="nav-tabContent">
                                            <!-- Div segunda -->
                                            <div class="tab-pane fade" id="nav-segunda10" role="tabpanel" aria-labelledby="nav-segunda5-tab">
                                                <form action="">
                                                    <div class="row mb-1 mt-3">
                                                        <div class="form-group mt-1 col-2">GM</div>
                                                        <div class="form-group mt-1 col-4">Exercicio</div>
                                    ...
                                    <div class="tab-pane fade" id="nav-s12" role="tabpanel" aria-labelledby="nav-s12-tab">
                                        ...
                                        <nav>
                                            <div class="nav nav-tabs" id="nav-tab" role="tablist">
                                                ...
                                                <a class="nav-item nav-link bg-info text-white" id="nav-sexta12-tab" data-toggle="tab" href="#nav-sexta12" role="tab" aria-controls="nav-sexta102 aria-selected="false">Sexta</a>
                                            </div>
                                        </nav>
                                        <div class="tab-content" id="nav-tabContent">
                                            <!-- Div segunda -->
